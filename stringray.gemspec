...
Gem::Specification.new do |s|
  ...
  s.extra_rdoc_files = ["lib/stringray/includes.rb", "lib/stringray.rb", "README.markdown"]
  s.files = ["lib/stringray/includes.rb", "lib/stringray.rb", "Rakefile.rb", "README.markdown", "spec/stringray_spec.rb", ".manifest", "stringray.gemspec"]
  s.has_rdoc = true
