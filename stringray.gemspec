...
Gem::Specification.new do |s|
  ...
  s.extra_rdoc_files = ["lib/stringray.rb", "lib/stringray/includes.rb", "lib/stringray/core_ext.rb", "lib/stringray/core_ext/kernel.rb", "lib/stringray/core_ext/spec/rake/verify_rcov.rb", "README.markdown"]
  s.files = ["lib/stringray.rb", "lib/stringray/includes.rb", "lib/stringray/core_ext.rb", "lib/stringray/core_ext/kernel.rb", "lib/stringray/core_ext/spec/rake/verify_rcov.rb", "spec/stringray_spec.rb", "README.markdown", "Rakefile.rb", ".manifest", "stringray.gemspec"]
  s.has_rdoc = true
