...
Gem::Specification.new do |s|
  ...
  s.extra_rdoc_files = ["lib/stringray/core_ext/spec/rake/verify_rcov.rb", "lib/stringray.rb", "README.mkdn"]
  s.files = ["lib/stringray/core_ext/spec/rake/verify_rcov.rb", "lib/stringray.rb", "Rakefile.rb", "README.mkdn", "spec/stringray_spec.rb", ".manifest", "stringray.gemspec"]
  s.has_rdoc = true
  s.homepage = %q{http://github.com/elliottcable/stringray}
  s.rdoc_options = ["--line-numbers", "--inline-source", "--title", "Stringray", "--main", "README.mkdn"]
  s.require_paths = ["lib"]
